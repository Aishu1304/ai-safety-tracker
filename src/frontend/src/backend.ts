...
export class Backend implements backendInterface {
    ...
    async getLocationHistory(): Promise<Array<Location>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLocationHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isDeviceOnline(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isDeviceOnline();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateDeviceStatus(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateDeviceStatus();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
